...
class EmergencyRestControllerIT {
  ...
  void getChildAlert_whenValidAddressAndExistedChildren_thenReturn200() throws Exception {
    ...
    mockMvc.perform(get("/childAlert").param("address", "1509 Culver St"))
        ...
        .andExpect(jsonPath("$.OtherMembers[0].firstName", is("John")))
        .andExpect(jsonPath("$.OtherMembers[0].lastName", is("Boyd")))
        .andExpect(jsonPath("$.OtherMembers[0].birthDate", is("03/06/1984")))
        .andExpect(jsonPath("$.OtherMembers[1].firstName", is("Jacob")))
        .andExpect(jsonPath("$.OtherMembers[1].lastName", is("Boyd")))
        .andExpect(jsonPath("$.OtherMembers[1].birthDate", is("03/06/1989")))
        .andExpect(jsonPath("$.OtherMembers[2].firstName", is("Felicia")))
        .andExpect(jsonPath("$.OtherMembers[2].lastName", is("Boyd")))
        .andExpect(jsonPath("$.OtherMembers[2].birthDate", is("01/08/1986")))
        .andDo(print());
